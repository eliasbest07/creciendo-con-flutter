                          ...
                          children: [
                            Column(
                              ...
                              children: [
                                ...
                                Text(listaProject[index].nombre, style:const TextStyle(fontSize: 18,fontWeight: FontWeight.w600)),
                                const SizedBox(height: 5),
                                Row(children: [
                          ...
                          children: [
                            Expanded(
                              ...
                              child: ClipRRect(
                                ...
                                height: 50,
                                shape: const Border(
                                    top: BorderSide(color: Colors.grey),    // Borde gris en la parte superior
                                    right: BorderSide(color: Colors.grey),  // Borde gris en el lado derecho
                                  ),
                                    color: Colors.white,
                                    onPressed: () {
